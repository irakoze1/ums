           ...
           <div class="col-lg-12">
               <div class="card-deck mt-3 text-light text-center font-weight-bold">
                   ...
                   <div class="card bg-warning">
                       <div class="card-header">verfied Users</div>
                       <div class="card-body">
                           <h1 class="diplay-4">
                           <?= $count->verfied_users(1) ?>
                           </h1>
                       </div>
                   </div>
                   <div class="card bg-success">
                       <div class="card-header">Unverfied Users</div>
                       <div class="card-body">
                           <h1 class="diplay-4">
                           <?= $count->verfied_users(0) ?>
                           </h1>
                       </div>
                   </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-deck my-3">
                    ...
                    <div class="card boder-info">
                        <div class="card-header bg-info text-center text-white lead">
                            Verfied/Unverfied User's Percentage
                        </div>
